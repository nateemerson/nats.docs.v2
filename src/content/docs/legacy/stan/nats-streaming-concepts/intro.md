...
![](../../../../../assets/.gitbook/assets/nats_streaming.svg)
...
NATS provides a [server binary](../nats-streaming-server/install) for Linux, Mac, and Windows. You can install the server from source on any platform you choose.
