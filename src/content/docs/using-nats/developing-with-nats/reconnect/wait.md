...
This setting not only prevents wasting client resources, it also alleviates a [_thundering herd_](random) situation when additional servers are not available.
